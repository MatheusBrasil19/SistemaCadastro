package appbolota.rede.ulbra.sistemacadastro;
...
public class TelaPrincipal {
    ...
    public void CarregarTela() {
        ...
        btcadastrar_usuario = (Button) act.findViewById(R.id.btnCadastro);
        bt_listar_usuarios_cadastrados = (Button) act.findViewById(R.id.btnListar);
